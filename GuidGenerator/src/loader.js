//Most of this code come from https://github.com/aspnet/Blazor/blob/4e5ee70d1db56bddd40700b12244721a1e729172/samples/MonoSanity/wwwroot/loader.js 

export function initMono(loadAssemblyUrls, onReadyCallback) {
    window.Browser = {
        init: function () { },
        asyncLoad: asyncLoad
    };
...
export function invokeMonoMethod(assemblyName, namespace, typeName, methodName, args) {
...
function javaScriptStringToDotNetString(javaScriptString) {
